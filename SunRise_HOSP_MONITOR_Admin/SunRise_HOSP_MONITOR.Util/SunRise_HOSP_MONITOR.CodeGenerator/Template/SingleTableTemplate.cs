...
using SunRise_HOSP_MONITOR.CodeGenerator.Model;
...
namespace SunRise_HOSP_MONITOR.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "SunRise_HOSP_MONITOR.Entity");
            baseConfigModel.OutputConfig.OutputBusiness = Path.Combine(path, "SunRise_HOSP_MONITOR.Business");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "SunRise_HOSP_MONITOR.Web", "SunRise_HOSP_MONITOR.Admin.Web");
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using SunRise_HOSP_MONITOR.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace SunRise_HOSP_MONITOR.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace SunRise_HOSP_MONITOR.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using SunRise_HOSP_MONITOR.Util;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Util.Extension;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Util.Model;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Data;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Data.Repository;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace SunRise_HOSP_MONITOR.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using SunRise_HOSP_MONITOR.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace SunRise_HOSP_MONITOR.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using SunRise_HOSP_MONITOR.Util;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Util.Model;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Entity;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Model;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Admin.Web.Controllers;");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using SunRise_HOSP_MONITOR.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace SunRise_HOSP_MONITOR.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "SunRise_HOSP_MONITOR.Entity", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityName + ".cs");
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "SunRise_HOSP_MONITOR.Model", "Param", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityParamName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "SunRise_HOSP_MONITOR.Service", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.ServiceName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "SunRise_HOSP_MONITOR.Business", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.BusinessName + ".cs");
                if (!File.Exists(codePath))
                {
