...
using SunRise_HOSP_MONITOR.Business.AutoJob;
using SunRise_HOSP_MONITOR.Admin.WebApi.Controllers;
...
namespace SunRise_HOSP_MONITOR.Admin.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                config.SwaggerDoc("v1", new OpenApiInfo { Title = "SunRise_HOSP_MONITOR Api", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("v1/swagger.json", "SunRise_HOSP_MONITOR Api v1");
            });
            app.UseRouting();
